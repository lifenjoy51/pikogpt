 ...
 * 예상대로 동작하는지 확인.
 */
class SimpleBPESpecialsTest {

    @Test
    fun defaultSpecialsAreAtFixedIds() {
        val bpe = SimpleBPE(maxVocabSize = 20, verbose = false)
    ...
    fun bosEosPreservedThroughEncoding() {
        // SimpleBPE는 special 토큰 주변에 공백을 붙여 단일 토큰으로 잡기 때문에,
    ...
    fun specialTokensNotMerged() {
        ...
        val bpe = SimpleBPE(maxVocabSize = 100, verbose = false)
