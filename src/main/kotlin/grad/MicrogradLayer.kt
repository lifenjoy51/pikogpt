 ...
 */
class MicrogradLayer(
    inputSize: Int,
    outputSize: Int,
    applyNonlinearity: Boolean = true
) {
    /** 이 레이어를 구성하는 뉴런들의 리스트 */
    val neurons: List<MicrogradNeuron> = List(outputSize) { MicrogradNeuron(inputSize, applyNonlinearity) }
    ...
    override fun toString(): String {
        return "MicrogradLayer of [${neurons.joinToString(", ")}]"
    }
}